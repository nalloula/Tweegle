...
--
-- Client :  127.0.0.1
-- Généré le :  Ven 02 Mars 2018 à 23:32
...
(1, 'contenttypes', '0001_initial', '2018-03-01 11:23:23.114076'),
(2, 'auth', '0001_initial', '2018-03-01 11:23:24.604738'),
(3, 'admin', '0001_initial', '2018-03-01 11:23:24.828564'),
(4, 'admin', '0002_logentry_remove_auto_add', '2018-03-01 11:23:24.839588'),
(5, 'contenttypes', '0002_remove_content_type_name', '2018-03-01 11:23:24.945047'),
(6, 'auth', '0002_alter_permission_name_max_length', '2018-03-01 11:23:25.000901'),
(7, 'auth', '0003_alter_user_email_max_length', '2018-03-01 11:23:25.069951'),
(8, 'auth', '0004_alter_user_username_opts', '2018-03-01 11:23:25.081960'),
(9, 'auth', '0005_alter_user_last_login_null', '2018-03-01 11:23:25.149023'),
(10, 'auth', '0006_require_contenttypes_0002', '2018-03-01 11:23:25.153024'),
(11, 'auth', '0007_alter_validators_add_error_messages', '2018-03-01 11:23:25.167036'),
(12, 'auth', '0008_alter_user_username_max_length', '2018-03-01 11:23:25.606360'),
(13, 'auth', '0009_alter_user_last_name_max_length', '2018-03-01 11:23:25.675910'),
(14, 'sessions', '0001_initial', '2018-03-01 11:23:25.784988'),
(15, 'tweegle', '0001_initial', '2018-03-01 11:23:25.873068'),
(16, 'tweegle', '0002_auto_20180204_0031', '2018-03-01 11:23:25.917106'),
(17, 'tweegle', '0003_auto_20180204_0032', '2018-03-01 11:23:25.962178'),
(18, 'tweegle', '0004_auto_20180204_0035', '2018-03-01 11:23:26.017223'),
(19, 'tweegle', '0005_auto_20180204_0224', '2018-03-01 11:23:26.022227'),
(20, 'tweegle', '0006_auto_20180301_1220', '2018-03-01 11:23:26.069976');
...
CREATE TABLE `tweegle_event` (
  `id` int(11) NOT NULL,
  `title` varchar(200) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Contenu de la table `tweegle_event`
--

INSERT INTO `tweegle_event` (`id`, `title`) VALUES
(0, 'Chinese author Mo Yan, famous for working in the style of writing known as hallucinatory realism, wins the Nobel Prize in Literature'),
(1, '12 Oct 2012 â€“ Paul Ryan spoke for 40 of the 90 minutes during Thursday night\'s vice presidential debate and managed to tell at least 24 myths during that time'),
...
(11, 'Barack Obama And Mitt Romney Went Head-To-Head In The Final Presidential Debate romney said not government that makes businesses successful!'),
...
(17, '2 Nov 2012 â€“ NEW YORK -- The National Hockey League today announced the cancellation of the 2013 Bridgestone NHL Winter Classic'),
...
(22, 'The Redbull Stratos jump was a space diving event.  Felix Baumgartner flew many miles into the air above the southwestern U.S. and then jumped, breaking several world records.'),
...
(25, 'The event is a college football game between LSU and Texas A&M. Many tweets refer to the loss by A&M and the players who contributed, specifically the kicker and the quarterback (Manziel.)'),
(26, ' UK\'s Lancashire Police apologises after an officer used a Taser on a blind man whose white cane was mistaken for a samurai sword'),
...
(32, 'Big Tex was a 52-foot (16 m) tall statue and marketing icon of the annual State Fair of Texas held at Fair Park in Dallas, Texas On October 19, 2012, the last weekend of the 2012 State Fair of Texas, '),
...
(36, 'the tweets are about the world series games. World Series is the annual championship series of North American-based Major League Baseball (MLB), played since 1903 between the American League (AL) and '),
(37, 'Soccer player Georgios Samaras scores a goal for Barcelona, tying the match at 1-1.'),
(38, 'The iPad Mini (stylized and marketed as iPad mini) is a mini tablet computer designed, developed, and marketed by Apple Inc. It was announced on October 23, 2012'),
...
(42, 'The East Coast of the United States prepares for Hurricane Sandy, which has killed at least 67 people and caused widespread damage in the Caribbean. '),
(43, 'Hurricane Sandy makes landfall near Atlantic City, New Jersey, with widespread flooding and at least 29 deaths in the Northeastern United States. '),
(44, 'Former Italian Prime Minister Silvio Berlusconi has been sentenced to four years in prison for tax fraud.'),
(45, 'Notre Dame and Alabama, two schools that are rumored to care a little bit about their football teams, will meet Jan. 7 in a BCS national championship'),
(46, 'purchase of  Lucasfilm Ltd. from George Lucas by Walt Disney Company '),
(47, 'Marcus Lattimore was hurt playing football'),
(48, 'A 7.7 magnitude earthquake strikes off the coast of British Columbia near Haida Gwaii, triggering a tsunami warning in the North Pacific. '),
(49, 'They are discussing the Cowboys vs Giants game.  Apparently the Cowboys almost came back to win, but lost in the closing seconds after a reviewed touchdown didn\'t go their way.'),
(50, 'The tweets are about The Los Angeles Lakers are an American professional basketball team based in Los Angeles and The Dallas Mavericks are a professional basketball team based in Dallas'),
...
(53, 'In the fourth round of the 2012â€“13 Football League Cup, Arsenal and Reading participate in a twelve-goal thriller (7-5) at the Mad Stad - with Arsenal 4-1 down by the end of the first half. '),
(54, 'Soccer match between Chelsea and Manchester United in which Chelsea wins'),
(55, 'Tweets discuss Tony Parker from the San Antonio Spurs shooting a buzzer beater shot over Russell Westbrook from the Oklahoma City Thunder.'),
...
(67, 'Voters in the states of Colorado and Washington approve the legalization of recreational use of marijuana in voter ballot initiatives, while the state of Massachusetts approves a referendum legalizing'),
...
(86, 'DALLAS (AP) â€” A Dallas woman who beat her 2-year-old daughter and glued the toddler\'s hands to a wall was sentenced Friday to 99 years in prison by a judge who described his decision as a necessary '),
(87, 'UFC middleweight contender Vitor Belfort doesn\'t see the point in having divisional top dog Anderson Silva fight welterweight champion Georges St-Pierre, but he believes Silva vs. Jon Jones is at leas'),
...
(116, '"The event discussed is an episode of the TV show Strictly Come Dancing"" in which contestant Bruce Forsyth dances to the song ""Gangnam Style."""""'),
...
(147, 'In anticipation of the arrival of Hurricane Sandy, New York Governor Mario Cuomo announced the suspension of all MTA (mass transit) service, beginning at 7 pm that Sunday.'),
...
(158, 'Dez Bryant\'s catch being ruled out-of-bounds due to his hand touching the white line.  Also, fans wondering why he was in time-out.'),
...
(169, 'Carrie Marie Underwood is an American country music singer she participate for The Country Music Association Awards, also known as the CMA Awards'),
...
(193, 'American weekly news magazine Newsweek announces it will cease print publication on December 31 and will move to an online-only format.'),
...
(196, 'when did the Boy Scouts of America release documents containing over 15,000 pages relating to allegations of sexual abuse by over 1200 scout leaders between 1965-1985.'),
...
(203, 'A car bomb explodes at Sassine Square in the Lebanese capital of Beirut, killing at least eight people and wounding up to 78 others.'),
...
(207, 'Faddy Abboud says an episode of the popular U.S. TV series Homeland misrepresented Beirut and is set to pursue legal action against its makers '),
...
(213, 'hief Whip of the British Conservative Party Andrew Mitchell resigns over remarks he made to police officers in Downing Street, and following a lengthy political row over the issue. '),
(214, 'how many civilians have died under artillery shelling attacks from militia forces.'),
(215, 'Israel targets rocket launching sites in Gaza in response to over 80 rockets being fired into Israeli territory by militants, causing deaths and injuries. '),
(216, 'which country  blames the explosion at a munition factory south of Khartoum on an Israeli airstrike.'),
(217, 'The UN peace envoy Lakhdar Brahimi states in Cairo that the Syrian government has agreed to a ceasefire during the four-day Muslim holiday, Eid al-Adha. '),
...
(220, 'An administrative law judge with the U.S. International Trade Commission issues a preliminary decision on a long-running Samsung/Apple dispute, in favor of Apple\'s complaint on four of the six patents'),
(221, 'Germany\'s rejection of asylum applications by Roma from Kosovo'),
(222, 'who resigns as Chief Constable of West Yorkshire Police as his role in the aftermath of the 1989 Hillsborough disaster is being investigated.'),
(223, '74 women formerly employed by Birmingham City Council are given permission to seek compensation'),
(224, 'The UK\'s Director of Public Prosecutions is to review a 2009 decision by the Crown Prosecution Service not to prosecute Jimmy Savile over allegations of sexual abuse. '),
(225, 'JÃ©rÃ´me Kerviel loses his appeal against a five-year prison sentence '),
(226, 'A former maintenance worker at Creflo Dollar\'s World Changers Church International in the Atlanta suburb of College Park, Georgia has fatally shot a 39-year-old church volunteer. '),
(227, 'arrest a 17-year-old resident who was allegedly involved in an attempted abduction in the killing of 10-year-old Jessica Ridgeway. '),
...
(237, 'Former British Labour Party minister Denis MacShane resigns his House of Commons seat after he wrongfully claimed at least Â£7,500 in expenses'),
...
(246, 'The USADA details witness-based doping claims against Lance Armstrong in its long-due report to the UCI. George Hincapie admits doping use over part of his career.'),
...
(258, 'Is there any person or peace keeping force not available in Burma to stop secterian clashes protecting for the loss of human life & property ?'),
(259, 'Fighting in Syria continues as the ceasefire agreement mediated by U.N. special envoy Lakhdar Brahimi to occur during the Muslim holiday of Eid al-Adha begins. '),
...
(267, 'The United Nations Security Council announces plans to impose sanctions on the leaders of Democratic Republic of the Congo\'s M23 rebel movement due to violations of an arms embargo. '),
...
(270, 'Worst flood in 40 years, force to evacuated hundreds of pilgrims from one of the respected Roman Catholic\'s Shrine site at Lourdes in France.'),
...
(273, 'Tens of thousands of protesters march through London, Glasgow and Belfast in a series of demonstrations against UK government austerity measures. '),
(274, 'multiple rockets being fired across the border, Israel launched four air strikes. Two militants from a Salafist jihadist group are killed and another wounded in the northern Gaza Strip.'),
(275, 'Peace one step move back Taliban\'s suicide bomber target peace supported millitant group office at Darra Adam Khel in FATA area of Pakistan, killed 15 and 30 wounded.'),
(276, 'Mexican army kills manuel felix leader sinaloa cartel'),
(277, 'skirmish in the North Caucasus republic of Dagestan. '),
(278, 'An oil painting by the German artist Gerhard Richter has sold for Â£21m ($34m) - an auction record for a work by a living artist. is it worthy enough for this price ?'),
(279, 'U.S. Federal Trade Commission is close to bringing an antitrust lawsuit against Google.'),
(280, 'Endeavour began its journey from Los Angeles international airport on Friday and finally arrived at the California Science Center.'),
...
(284, 'Ireland soccer manager Giovanni Trapattoni refuses to resign following last night\'s humiliation at the hands of Germany in 2014 FIFA World Cup qualification'),
...
(288, 'The Lebanese Army launches an operation to quell the sectarian violence in Beirut triggered by the assassination of Wissam al-Hassan. '),
(289, 'south africa shooting miners'),
(290, 'account wiped and all her paid-for books deleted by Amazon.com.'),
(291, 'A former Goldman Sachs employee blows the whistle on the investment bank having routinely taken advantage of charities and pension funds to increase its profits. '),
...
(303, 'A policeman is killed and 11 others are injured in a grenade attack on a church in the Kenyan town of Garissa near the border with Somalia'),
...
(312, 'Several structures were set ablaze and as many as 24 militants were killed after suspected bombing Boko Haram attacks rocked the Nigerian city of Maiduguri. '),
(313, 'Shootout between Yemen\'s army and Al-Qaeda militants killed four in ongoing fight to clear the Al-queda infested southern Yemen from terrorist acitvities.'),
(314, 'United Nations expert panel reports that although the two governments deny it, Rwanda and Uganda continue to support the March 23 Movement.'),
...
(324, 'The Brazilian jurisprudence system upholds the convictions of two United States pilots for their roles in the 2006 Gol Transportes AÃ©reos Flight 1907 disaster.'),
...
(337, 'African land locked national Malawi suspend his anti homosexual and gay law to improve national image of Malawi towards the developed world.'),
(338, ' five people are reported shot at a workplace (Apple Valley Farms, a poultry and meat processing plant with about 50 employees) in central Fresno, California.'),
(339, 'In the United States Congress, the Senate is projected to maintain a Democratic majority '),
(340, 'Voters in Palau go to the polls with incumbent President Johnson Toribiong and former President Tommy Remengesau both competing for the presidency. '),
(341, 'Russian President Vladimir Putin sacks the defence minister Anatoly Serdyukov amid a corruption scandal. '),
(342, 'Nadine Dorries is suspended from the party after her decision to become the first serving politician to appear on a reality television series'),
...
(357, 'The Philippine governmen  & he Moro Islamic Liberation Front, sign a peace pact.  Related Article: http://www.aljazeera.com/video/asia-pacific/2012/10/2012101524117145978.html'),
...
(368, 'Police deal tough with Anglo American platinum mine workers, during their month long strike at outside of Johansburg, South Africa '),
...
(373, '" Alan Bennett reveals it emerged as a result of disquiet at the National Trust and laments a nation turned into a captive market"" where public life exhibits a ""diminution of magnanimity."" """'),
(374, 'Tamasin and Daniel Day-Lewis donate poet laureate Cecil Day-Lewis\'s archive - including manuscripts and a letter from W. H. Auden - to Oxford University\'s Bodleian Library. '),
...
(377, '"Organisers of a proposed free public event on Homo floresiensis are forced to change the event\'s title after use of the word hobbit"", the creature\'s nickname, is forbidden."""'),
(378, 'allegedly fatally stabbing her 7-year-old son, Justin, Tuesday night 100 times, and then killing a 5-year-old girl, Olivia Dworakowski, who she had been babysitting and who had witnessed the homicide.'),
...
(396, 'Continuation of violance against Iraqi\'s Shia community Car bomb exploded in shia dominant city of Shula, nine dead and many wounded believed to be done by Sunni Militants groups.'),
(397, 'A young Pakistani man, whose father was killed by drones alongside 40 others in March 2011, seeks to block the sharing of British intelligence with the CIA'),
...
(406, 'The analogue TV signal in Northern Ireland is turned off permanently at 23:30 BST, completing the final stage of the UK digital switchover. Ceefax, the world\'s first teletext information service, is a'),
...
(409, 'Four civil cases are filed against Trinity Mirror, publishers of the UK newspaper the Daily Mirror, over allegations of phone hacking. '),
(410, 'Four third-party U.S. presidential election candidates - representing the Libertarian, Green, Constitution, and Justice parties, who were excluded from the high-profile televised encounters between Mi'),
...
(421, 'ezbollah leader Hassan Nasrallah confirms that the drone aircraft shot down over Israel\'s Negev Desert on 6 October belonged to the organization and was supplied by Iran. '),
...
(424, 'The Marie Stopes organisation is to open the first private clinic to offer abortions to women in Northern Ireland from 18 October. '),
...
(427, 'A U.S. appeals court has overturned a district court order that had banned the sale of Samsung\'s Galaxy Nexus in the US, delivering a winning round for Google\'s Android against Apple Inc.. '),
...
(440, 'The Syrian government announces via its state media that it will suspend military operations from Friday to Monday, during this year\'s Muslim Eid al-Adha holiday'),
...
(447, '6-year employee Gilberto Valle III along with an unnamed co-conspirator, is charged with allegedly conspiring to cross state lines and kidnap'),
(448, 'U.S. presidential candidate Mitt Romney\'s campaign is linked to Hart InterCivic a firm providing the voting machines to be used to tally the ballots in the crucial state of Ohio'),
...
(451, 'Israeli Prime Minister and Likud chairman Benjamin Netanyahu and the Israeli Foreign Minister and Yisrael Beiteinu chairman Avigdor Lieberman announce the unification of their two parties'),
...
(457, 'Human Rights Watch and other rights groups issue a report rejecting the Israeli governmentâ€™s arguments against accepting Africans migrants'),
...
(469, 'The UK\'s Ministry of Defence will hold an investigation after journalists from The Sunday Times posed as lobbyists for a defence manufacturer and approached several senior retired officers to ask if t'),
(470, 'Former United States Senator Arlen Specter, who was vital in several United States Supreme Court nominations, dies at the age of 82'),
...
(493, 'Five bombs go off in the neighborhoods of Gudaibiya and Adliya in Manama, Bahrain, killing two foreign workers and injuring another. '),
(494, 'floods in nigeria, number of people affected '),
(495, 'he biennial naval training exercise Keen Sword between the United States Navy and the Japan Maritime Self-Defense Force commences off the shore off Okinawa amid tension with China. ');
INSERT INTO `tweegle_event` (`id`, `title`) VALUES
(496, 'Asian and European leaders meet at the Ninth Asiaâ€“Europe Meeting in Vientiane.'),
(497, 'British Prime Minister David Cameron orders a fresh investigation into allegations of sexual abuse involving a senior Conservative politician from the Thatcher era. '),
...
--
-- Index pour la table `tweegle_event`
--
ALTER TABLE `tweegle_event`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT pour la table `tweegle_event`
--
ALTER TABLE `tweegle_event`
